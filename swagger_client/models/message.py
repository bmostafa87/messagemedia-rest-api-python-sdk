...
class Message(object):
    ...
    """
    def __init__(self, content=None, callback_url=None, delivery_report=False, destination_number=None, format='SMS', metadata=None, message_expiry_timestamp=None, scheduled=None, source_address=None, source_address_type=None, message_id=None, status=None):
        """
    ...
    def callback_url(self):
        """
        Gets the callback_url of this Message.
        URL replies and delivery reports to this message will be pushed to.

        :return: The callback_url of this Message.
        :rtype: str
        """
    ...
    def callback_url(self, callback_url):
        """
        Sets the callback_url of this Message.
        URL replies and delivery reports to this message will be pushed to.

        :param callback_url: The callback_url of this Message.
        :type: str
        """
    ...
    def delivery_report(self):
        """
        Gets the delivery_report of this Message.


        :return: The delivery_report of this Message.
        :rtype: bool
        """
    ...
    def delivery_report(self, delivery_report):
        """
        Sets the delivery_report of this Message.


        :param delivery_report: The delivery_report of this Message.
        :type: bool
        """
    ...
    def destination_number(self):
        """
        Gets the destination_number of this Message.
        Destination number of the message.

        :return: The destination_number of this Message.
        :rtype: str
        """
    ...
    def destination_number(self, destination_number):
        """
        Sets the destination_number of this Message.
        Destination number of the message.

        :param destination_number: The destination_number of this Message.
        :type: str
        """
    ...
    def message_expiry_timestamp(self):
        """
        Gets the message_expiry_timestamp of this Message.
        Date time after which the message is considered expired in ISO8601 format.

        :return: The message_expiry_timestamp of this Message.
        :rtype: datetime
        """
    ...
    def message_expiry_timestamp(self, message_expiry_timestamp):
        """
        Sets the message_expiry_timestamp of this Message.
        Date time after which the message is considered expired in ISO8601 format.

        :param message_expiry_timestamp: The message_expiry_timestamp of this Message.
        :type: datetime
        """
    ...
    def scheduled(self):
        """
        Gets the scheduled of this Message.
        Date time at which the message is scheduled for in ISO8601 format.

        :return: The scheduled of this Message.
        :rtype: datetime
        """
    ...
    def scheduled(self, scheduled):
        """
        Sets the scheduled of this Message.
        Date time at which the message is scheduled for in ISO8601 format.

        :param scheduled: The scheduled of this Message.
        :type: datetime
        """
    ...
    def source_address(self):
        """
        Gets the source_address of this Message.


        :return: The source_address of this Message.
        :rtype: str
        """
    ...
    def source_address(self, source_address):
        """
        Sets the source_address of this Message.


        :param source_address: The source_address of this Message.
        :type: str
        """
    ...
    def source_address_type(self):
        """
        Gets the source_address_type of this Message.
        Type of source address specified.

        :return: The source_address_type of this Message.
        :rtype: str
        """
    ...
    def source_address_type(self, source_address_type):
        """
        Sets the source_address_type of this Message.
        Type of source address specified.

        :param source_address_type: The source_address_type of this Message.
        :type: str
        """
